...
function isValidAddress(value) {
  ...
  re = new RegExp('^'+conf.program.replace(/byteball/i, 'mcm')+':([A-Z2-7]{32})\b', 'i');
  ...
  .directive('logo', function() {
    return {
      ...
      controller: function($scope) {
        ...
        $scope.logo_url = $scope.negative ? 'img/icons/mcm-logo-negative.svg' : 'img/icons/mcm-logo.svg';
      },
      replace: true,
      template: '<img ng-style="styles" ng-src="{{ logo_url }}" alt="MCM">'
    }
  })
