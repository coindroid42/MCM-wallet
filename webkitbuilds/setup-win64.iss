...
#define MyAppName "MCM"
#define MyAppPackageName "MCM"
#define MyAppVersion "2.7.2"
#define MyAppPublisher "MCM"
#define MyAppURL "https://mcm.org"
#define MyAppExeName "MCM.exe"
...
Root: HKLM; Subkey: "Software\Classes\mcm"; Flags: uninsdeletekey
Root: HKLM; Subkey: "Software\Classes\mcm"; ValueType: string; ValueName: ""; ValueData: "URL:MCM Protocol"
Root: HKLM; Subkey: "Software\Classes\mcm"; ValueType: string; ValueName: "URL Protocol"; ValueData: ""
Root: HKLM; Subkey: "Software\Classes\mcm\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\icon.ico"
Root: HKLM; Subkey: "Software\Classes\mcm\shell"
Root: HKLM; Subkey: "Software\Classes\mcm\shell\open"
Root: HKLM; Subkey: "Software\Classes\mcm\shell\open\command"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName} ""%1"""
...
[Files]
Source: "..\..\mcmbuilds\{#MyAppPackageName}\win64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
