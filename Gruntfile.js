module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      osx64: {
        command: '../mcmbuilds/build-osx.sh osx64'
      },
      osx32: {
        command: '../mcmbuilds/build-osx.sh osx32'
      }
    },
    watch: {
      options: {
    ...
    copy: {
      ...
      linux: {
		options: {timestamp: true, mode: true},
        files: [
          {expand: true, cwd: './webkitbuilds/', src: ['mcm.desktop', '../public/img/icons/logo-circle.ico', '../public/img/icons/logo-circle-256.png'], dest: '../mcmbuilds/MCM/linux32/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
          {expand: true, cwd: './webkitbuilds/', src: ['mcm.desktop', '../public/img/icons/logo-circle.ico', '../public/img/icons/logo-circle-256.png'], dest: '../mcmbuilds/MCM/linux64/', flatten: true, filter: 'isFile', options: {timestamp: true, mode: true} },
        ],
      }
    },
    /*karma: {
    ...
    nwjs: {
      options: {
          ...
          macPlist: {
          	CFBundleURLTypes: [{CFBundleURLName: 'MCM action', CFBundleURLSchemes: ['byteball', 'mcm']}],
      		/*CFBundleIconFile: 'nw.icns',*/
      		LSHasLocalizedDisplayName: 0,
      		UTExportedTypeDeclarations: [{
      			UTTypeIdentifier: 'org.mcm.coin',
      			UTTypeDescription: 'MCM Private Coin',
      		...
      		CFBundleDocumentTypes: [{
      			CFBundleTypeName: "MCM Private Coin",
      			LSItemContentTypes: ["org.mcm.coin"],
    ...
    compress: {
      linux32: {
        options: {
          archive: '../mcmbuilds/mcm-linux32.zip'
        },
        expand: true,
        cwd: '../mcmbuilds/MCM/linux32/',
        src: ['**/*'],
        dest: 'mcm-linux32/'
      },
      linux64: {
        options: {
          archive: '../mcmbuilds/mcm-linux64.zip'
        },
        expand: true,
        cwd: '../mcmbuilds/MCM/linux64/',
        src: ['**/*'],
        dest: 'mcm-linux64/'
      }
    },
    ...
    debian_package: {
        linux64: {
            files: [
                {expand: true, cwd: '../mcmbuilds/mcm-test/linux64/', src: ['**/*'], dest: '/opt/mcm-test/'},
                //{expand: true, cwd: '../mcmbuilds/mcm-test/linux64', src: ['mcm.desktop'], dest: '/usr/share/applications/mcm-test.desktop'}
            ],
            options: {
                maintainer: {
                    name: 'MCM',
